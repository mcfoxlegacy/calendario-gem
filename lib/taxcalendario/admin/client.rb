...
module Taxcalendario
  module Admin
    module Client
      ...
      class UserService < Taxcalendario::Client::BasicClient
      ...
      class ObrigacaoService < Taxcalendario::Client::BasicClient
        def initialize
      ...
      class ContaService < Taxcalendario::Client::BasicClient
        ...
        def users_list(conta_id)
          ...
          list_contas.each do |u_map|
            user = Taxcalendario::Admin::Client::Entities::User.new
        ...
        def responsabilidades(conta_id, user_id)
          ...
          rtn = []
          list.each do |map|
            obj = Taxcalendario::Admin::Client::Entities::Responsabilidade.new
            obj.from_hash(map)
            rtn << obj
          end
          rtn
        ...
        def responsabilidades_estabelecimento(conta_id, estabelecimento_id, user_id)
          ...
          list_resp.each do |u_map|
            resp = Taxcalendario::Admin::Client::Entities::Responsabilidade.new
        ...
        def estabelecimentos_by_cnpj(conta_id, cnpj)
          ...
          rtn = []
          list.each do |map|
            obj = Taxcalendario::Admin::Client::Entities::Estabelecimento.new
            obj.from_hash(map)
            rtn << obj
          end
          rtn
        ...
        def list_entregas(conta_id, estabelecimento_id, obrigacao_id)
          ...
          rtn = []
          list.each do |map|
            obj = Taxcalendario::Admin::Client::Entities::Entrega.new
            obj.from_hash(map)
            rtn << obj
          end
          rtn
